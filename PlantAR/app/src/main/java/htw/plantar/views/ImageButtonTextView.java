...
public class ImageButtonTextView extends RelativeLayout
{
	@SuppressWarnings("deprecation")
	public ImageButtonTextView(Context context, int id) 
	{
		super(context);
        ...
        bt.setBackgroundColor(context.getResources().getColor(R.color.background_list_color_light_black));
        ...
        while (layout.getChildCount() > 0)
        {
             ...
             if (vchild instanceof TextView  )
             {
                ...
                ((TextView)vchild).setTextColor(context.getResources().getColor(R.color.text_foreground_color_white));
             }
